...
export class ProfileService {
  ...
  constructor(private http: Http) {
    ...
    this.searchString = 'karthikjeeyar';
  }

  getUserProfileInfo() {
    return this.http.get(`https://api.github.com/users/${this.searchString}?client_id=${this.clientId}&client_secret=${this.clientSecret}`)
